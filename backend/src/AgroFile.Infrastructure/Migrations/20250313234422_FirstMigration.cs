        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateIpClient = table.Column<string>(type: "text", nullable: true),
                    UpdateIpClient = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Coutry = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    CreateIpClient = table.Column<string>(type: "text", nullable: true),
                    UpdateIpClient = table.Column<string>(type: "text", nullable: true),
                    CreateTime = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    UpdateTime = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_YearsManagement", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BirthdayDate = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    IndividualRegistration = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UniqueIdentifier = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Plots_Estates_EstateId",
                        column: x => x.EstateId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccountTransactions_AspNetUsers_UserCreateId",
                        column: x => x.UserCreateId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_AccountTransactions_PaymentMethods_PaymentMethodId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountTransactions_PaymentMethodId",
                table: "AccountTransactions",
                column: "PaymentMethodId");

            migrationBuilder.CreateIndex(
                name: "IX_AccountTransactions_UserCreateId",
                table: "AccountTransactions",
                column: "UserCreateId");
